...
class EventHandler(BaseEventHandler):
    ...
    def handle_events(self, event: tcod.event.Event) -> BaseEventHandler:
        """Handle the events for input handlers with an engine"""
...
class InventoryEventHandler(AskUserEventHandler):
    ...
    def on_render(self, console: tcod.Console) -> None:
        """Render an inventory menu, which displays the items in the inventory, and the letter to select the item.
...
class GameOverEventHandler(EventHandler):
    def on_quit(self) -> None:
        ...
        if os.path.exists("savegame.sav"):
            os.remove("savegame.sav") # Delete active save file
...
class HistoryViewer(EventHandler):
    ...
    def on_render(self, console: tcod.Console) -> None:
        ...
        # Draw a frame with a custom banner
